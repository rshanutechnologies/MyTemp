...
const lineColors = ["#ff6b6b", "#4dabf7", "#51cf66", "#ffd43b", "#b197fc"];
...
function attempt(el,p){
 ...
 if(!armed || el.classList.contains("correct"))
 return;
...
// CORRECT ANSWER
 ...
 if(armed.p.r===p.r){
   ...
   const leftEl = armed.el;

   leftEl.classList.remove("armed");
   ...
   leftEl.querySelector(".match-letter")
   .textContent = letter;
...
// WRONG ANSWER
   ...
   // right selection removed immediately

   el.classList.remove("active");


   // left remains selected

   armed.el.classList.add("active");
