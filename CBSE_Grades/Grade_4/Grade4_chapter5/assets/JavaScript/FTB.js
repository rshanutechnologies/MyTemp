const questions = [
  {
    q: "Q1. _________ is made up of two or more simple machines.",
    a: ["complex machine"],
  ...
  {
    q: "Q4. ___________is the force that is applied to move things.",
    a: ["effort"],
    img: "../assets/images/FTB_Q4.png",
  },
  {
    q: "Q5. A ladder is an example of an ___________.",
    a: ["inclined plane"],
