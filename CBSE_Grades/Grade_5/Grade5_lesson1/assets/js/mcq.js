const quiz = [
  {
    q: "Q1. The ovary contains one or more small egg-like structures called the___.",
    options: [
      { text: "Stigma", img: "../assets/images/stigmaak.png" },
      { text: "Style", img: "../assets/images/style.png" },
      { text: "Ovules", img: "../assets/images/ovulesM.png" },
  ...
  {
    q: "Q2. The style has a small disc-like structure at its tip called the _____ .",
    options: [
      { text: "Anther", img: "../assets/images/Anther.png" },
      { text: "Stigma", img: "../assets/images/stigmaak.png" },
      { text: "Carpel", img: "../assets/images/carpelak.png" },
      { text: "Ovule", img: "../assets/images/ovulesM.png" },
    ],
    answer: 1,
  ...
  {
    q: "Q3. The ______ is the female reproductive part of a flower.",
    options: [
