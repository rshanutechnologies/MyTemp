const quiz = [
  ...
  {
    q: "Q4.  Study the given relationship based on dispersal of seeds in plants. Select the option which correctly satisfies the same relationship.",
    options: [
      {
        text: "Peas : Lady’s finger : Lentils",
        img: "../assets/images/mcq41.png",
      },
      {
        text: "Green gram : Lotus : Dandelion",
        img: "../assets/images/mcq42.png",
      },
      {
        text: "Calotropis : Water lily : Burdock",
        img: "../assets/images/mcq43.png",
      },
      {
        text: "Tiger’s claw : Xanthium : Milkweed",
  ...
  {
    q: "Q5. Which of the following features enable dispersal of seeds by water?",
    options: [
      {
        text: "Small size,light weight and hair-like structures",
        img: "../assets/images/mcq51.png",
      },
...
`;
    ...
    if (answered[index]) {
      if (i === quiz[index].answer) {
        ...
        btn.classList.add("disabledOption");
      }
    }
